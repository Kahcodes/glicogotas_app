...
import 'package:glicogotas_app/Livro/hipo-livro/hipo2.dart';
import 'package:glicogotas_app/Livro/hipo-livro/hipo4.dart';
...
class Hipo3Page extends StatefulWidget {
  const Hipo3Page({super.key});

  @override
  State<Hipo3Page> createState() => _Hipo3PageState();
}

class _Hipo3PageState extends State<Hipo3Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hipoglicemia/tela3-hipoglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hipoglicemia/tela3-hipoglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hipo2Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hipo4Page()),
                    );
                  },
                ),
              ),
