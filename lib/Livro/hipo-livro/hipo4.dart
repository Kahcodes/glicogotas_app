...
class _Hipo4PageState extends State<Hipo4Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hipoglicemia/tela4-hipoglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hipoglicemia/tela4-hipoglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
