...
import 'package:glicogotas_app/Livro/hipo-livro/hipo6.dart';
import 'package:glicogotas_app/Livro/hipo-livro/hipo8.dart';
...
class Hipo7Page extends StatefulWidget {
  const Hipo7Page({super.key});

  @override
  State<Hipo7Page> createState() => _Hipo7PageState();
}

class _Hipo7PageState extends State<Hipo7Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hipoglicemia/tela7-hipoglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hipoglicemia/tela7-hipoglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hipo6Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hipo8Page()),
                    );
                  },
                ),
              ),
