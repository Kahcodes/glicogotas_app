...
class Hipo1Page extends StatefulWidget {
  const Hipo1Page({super.key});

  @override
  State<Hipo1Page> createState() => _Hipo1PageState();
}

class _Hipo1PageState extends State<Hipo1Page> with RouteAware {
...
class Hipo1Content extends StatelessWidget {
  const Hipo1Content({super.key});
