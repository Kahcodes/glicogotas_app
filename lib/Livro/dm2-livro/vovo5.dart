...
class Vovo5Page extends StatefulWidget {
  const Vovo5Page({super.key});

  @override
  State<Vovo5Page> createState() => _Vovo5PageState();
}

class _Vovo5PageState extends State<Vovo5Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-5.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-5.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo4Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo6Page()),
                    );
                  },
                ),
              ),
