...
class _Vovo5PageState extends State<Vovo5Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-diabtp2/diabtp2-5.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-diabtp2/diabtp2-5.mp3', context); // Reinicia o áudio ao voltar
  }
