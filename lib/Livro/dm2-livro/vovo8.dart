...
class Vovo8Page extends StatefulWidget {
  const Vovo8Page({super.key});

  @override
  State<Vovo8Page> createState() => _Vovo8PageState();
}

class _Vovo8PageState extends State<Vovo8Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-8.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-8.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo7Page()),
                    );
                  },
                ),
              ),
