...
class Vovo2Page extends StatefulWidget {
  const Vovo2Page({super.key});

  @override
  State<Vovo2Page> createState() => _Vovo2PageState();
}

class _Vovo2PageState extends State<Vovo2Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-diabtp2/diabtp2-2.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-diabtp2/diabtp2-2.mp3', context); // Reinicia o áudio ao voltar
  }
