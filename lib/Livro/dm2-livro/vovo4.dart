...
class Vovo4Page extends StatefulWidget {
  const Vovo4Page({super.key});

  @override
  State<Vovo4Page> createState() => _Vovo4PageState();
}

class _Vovo4PageState extends State<Vovo4Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-4.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-4.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo3Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo5Page()),
                    );
                  },
                ),
              ),
