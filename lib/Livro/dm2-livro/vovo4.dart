...
class _Vovo4PageState extends State<Vovo4Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-diabtp2/diabtp2-4.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-diabtp2/diabtp2-4.mp3', context); // Reinicia o áudio ao voltar
  }
