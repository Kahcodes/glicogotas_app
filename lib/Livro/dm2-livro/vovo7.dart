...
class Vovo7Page extends StatefulWidget {
  const Vovo7Page({super.key});

  @override
  State<Vovo7Page> createState() => _Vovo7PageState();
}

class _Vovo7PageState extends State<Vovo7Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-7.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-7.mp3', context); // Reinicia o áudio ao voltar
  }
