...
class _Vovo7PageState extends State<Vovo7Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-diabtp2/diabtp2-7.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-diabtp2/diabtp2-7.mp3', context); // Reinicia o áudio ao voltar
  }
