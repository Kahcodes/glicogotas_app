...
class Vovo9Page extends StatefulWidget {
  const Vovo9Page({super.key});

  @override
  State<Vovo9Page> createState() => _Vovo9PageState();
}

class _Vovo9PageState extends State<Vovo9Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-9.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('assets/audio/audios-diabtp2/diabtp2-9.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Vovo8Page()),
                    );
                  },
                ),
              ),
