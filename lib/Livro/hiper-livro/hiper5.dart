...
class Hiper5Page extends StatefulWidget {
  const Hiper5Page({super.key});

  @override
  State<Hiper5Page> createState() => _Hiper5PageState();
}

class _Hiper5PageState extends State<Hiper5Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela5-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela5-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hiper4Page()),
                    );
                  },
                ),
              ),
