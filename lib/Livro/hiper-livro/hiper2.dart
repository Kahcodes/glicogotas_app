...
class Hiper2Page extends StatefulWidget {
  const Hiper2Page({super.key});

  @override
  State<Hiper2Page> createState() => _Hiper2PageState();
}

class _Hiper2PageState extends State<Hiper2Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela2-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela2-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
