...
class Hiper4Page extends StatefulWidget {
  const Hiper4Page({super.key});

  @override
  State<Hiper4Page> createState() => _Hiper4PageState();
}

class _Hiper4PageState extends State<Hiper4Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela4-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela4-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hiper3Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hiper5Page()),
                    );
                  },
                ),
              ),
