...
class Hiper6Page extends StatefulWidget {
  const Hiper6Page({super.key});

  @override
  State<Hiper6Page> createState() => _Hiper6PageState();
}

class _Hiper6PageState extends State<Hiper6Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela6-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela6-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
