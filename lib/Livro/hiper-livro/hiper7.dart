...
class Hiper7Page extends StatefulWidget {
  const Hiper7Page({super.key});

  @override
  State<Hiper7Page> createState() => _Hiper7PageState();
}

class _Hiper7PageState extends State<Hiper7Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela7-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela7-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hiper6Page()),
                    );
                  },
                ),
              ),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Hiper8Page()),
                    );
                  },
                ),
              ),
