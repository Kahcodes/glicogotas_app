...
class Hiper3Page extends StatefulWidget {
  const Hiper3Page({super.key});

  @override
  State<Hiper3Page> createState() => _Hiper3PageState();
}

class _Hiper3PageState extends State<Hiper3Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/audios-hiperglicemia/tela3-hiperglicemia.mp3', context); // Reproduz o áudio
  }
  ...
  @override
  void didPopNext() {
    _audioManager.play('audio/audios-hiperglicemia/tela3-hiperglicemia.mp3', context); // Reinicia o áudio ao voltar
  }
