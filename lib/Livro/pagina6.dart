...
class Pagina6PageState extends State<Pagina6Page> with RouteAware {
  ...
  void initState() {
    ...
    _audioManager.play('audio/panc-pagina6.mp3', context); // Reproduz o áudio
  }
  ...
  void didPopNext() {
    _audioManager.play(
        'audio/panc-pagina5.mp3', context); // Reinicia o áudio ao voltar
  }
            ...
            child: IconButton(
              ...
              onPressed: () {
                ...
                PageDatabase.instance
                    .saveCurrentPage(8); // Para o áudio ao navegar
                Navigator.pushReplacement(
                  context,
