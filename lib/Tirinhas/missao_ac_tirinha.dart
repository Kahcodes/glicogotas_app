...
class TirinhaMissao extends StatefulWidget {
  const TirinhaMissao({super.key});

  @override
  TirinhaMissaoState createState() => TirinhaMissaoState();
}

class TirinhaMissaoState extends State<TirinhaMissao> {
  final List<String> tirinha = [
    'assets/images/missao-tirinha.svg',
  ];
