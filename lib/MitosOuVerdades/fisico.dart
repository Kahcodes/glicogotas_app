...
class _ExerciciosScreenState extends State<ExerciciosScreen> {
  final List<Map<String, dynamic>> mitosVerdades = [
    {
      'pergunta': 'Quem tem diabetes pode praticar atividades físicas?',
